...

{
  ...
  "location": "Their specific city or town location (e.g. 'London', 'Manchester', 'Birmingham'). Do NOT return just a country like 'UK' or 'United Kingdom' - only return a specific city/town/region. If only a country is mentioned, omit this field.",
...
${text.substring(0, 8000)}`;
    ...
    return {
      ...
      location: parsed.location && !["uk", "united kingdom", "england", "scotland", "wales", "great britain"].includes(parsed.location.toLowerCase().trim()) ? parsed.location : undefined,
